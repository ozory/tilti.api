...
namespace Infrastructure.Data.Postgreesql.Migrations
{
    ...
    [Migration("20240213165308_Orders")]
            ...
            modelBuilder.Entity("Infrastructure.Data.Postgreesql.Features.Orders.Entities.Order", b =>
                {
                    ...
                    b.Property<DateTime>("Updated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp")
                        .HasDefaultValue(new DateTime(2024, 2, 13, 13, 53, 8, 271, DateTimeKind.Local).AddTicks(8060))
            ...
            modelBuilder.Entity("Infrastructure.Data.Postgreesql.Features.Plans.Entities.Plan", b =>
                {
                    ...
                    b.Property<DateTime>("Updated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp")
                        .HasDefaultValue(new DateTime(2024, 2, 13, 13, 53, 8, 274, DateTimeKind.Local).AddTicks(7070))
                        .HasColumnName("Updated");
            ...
            modelBuilder.Entity("Infrastructure.Data.Postgreesql.Features.Subscriptions.Entities.Subscription", b =>
                {
                    ...
                    b.Property<DateTime>("Updated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp")
                        .HasDefaultValue(new DateTime(2024, 2, 13, 13, 53, 8, 274, DateTimeKind.Local).AddTicks(5040))
                        .HasColumnName("Updated");
            ...
            modelBuilder.Entity("Infrastructure.Data.Postgreesql.Features.Users.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("Updated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp")
                        .HasDefaultValue(new DateTime(2024, 2, 13, 13, 53, 8, 274, DateTimeKind.Local).AddTicks(8510))
                        .HasColumnName("Updated");
