...
namespace Infrastructure.Data.Postgreesql.Migrations
{
    ...
    [Migration("20240313205606_Document")]
            ...
            modelBuilder.Entity("Domain.Features.Orders.Entities.Order", b =>
                {
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp")
                        .HasDefaultValue(new DateTime(2024, 3, 13, 17, 56, 6, 173, DateTimeKind.Local).AddTicks(8870))
            ...
            modelBuilder.Entity("Domain.Features.Plans.Entities.Plan", b =>
                {
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp")
                        .HasDefaultValue(new DateTime(2024, 3, 13, 17, 56, 6, 177, DateTimeKind.Local).AddTicks(4980))
                        .HasColumnName("Updated")
                        .HasColumnOrder(6);
            ...
            modelBuilder.Entity("Domain.Features.Subscriptions.Entities.Subscription", b =>
                {
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp")
                        .HasDefaultValue(new DateTime(2024, 3, 13, 17, 56, 6, 176, DateTimeKind.Local).AddTicks(7620))
                        .HasColumnName("Updated");
            ...
            modelBuilder.Entity("Domain.Features.Users.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp")
                        .HasDefaultValue(new DateTime(2024, 3, 13, 17, 56, 6, 182, DateTimeKind.Local).AddTicks(200))
                        .HasColumnName("Updated")
                        .HasColumnOrder(14);
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Document", "Domain.Features.Users.Entities.User.Document#Document", b1 =>
                        {
                            b1.IsRequired();
