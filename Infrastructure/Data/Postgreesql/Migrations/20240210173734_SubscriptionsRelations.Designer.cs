...
namespace Infrastructure.Data.Postgreesql.Migrations
{
    ...
    [Migration("20240210173734_SubscriptionsRelations")]
    partial class SubscriptionsRelations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Infrastructure.Data.Postgreesql.Features.Plans.Entities.Plan", b =>
                {
                    ...
                    b.Property<DateTime>("Updated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp")
                        .HasDefaultValue(new DateTime(2024, 2, 10, 14, 37, 34, 383, DateTimeKind.Local).AddTicks(820))
            ...
            modelBuilder.Entity("Infrastructure.Data.Postgreesql.Features.Subscriptions.Entities.Subscription", b =>
                {
                    ...
                    b.Property<DateTime>("Updated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp")
                        .HasDefaultValue(new DateTime(2024, 2, 10, 14, 37, 34, 382, DateTimeKind.Local).AddTicks(8610))
                        .HasColumnName("Updated");
            ...
            modelBuilder.Entity("Infrastructure.Data.Postgreesql.Features.Users.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("Updated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp")
                        .HasDefaultValue(new DateTime(2024, 2, 10, 14, 37, 34, 383, DateTimeKind.Local).AddTicks(2200))
                        .HasColumnName("Updated");
