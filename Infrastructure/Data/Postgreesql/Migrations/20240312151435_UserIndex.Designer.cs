...
namespace Infrastructure.Data.Postgreesql.Migrations
{
    ...
    [Migration("20240312151435_UserIndex")]
            ...
            modelBuilder.Entity("Domain.Features.Orders.Entities.Order", b =>
                {
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp")
                        .HasDefaultValue(new DateTime(2024, 3, 12, 12, 14, 34, 943, DateTimeKind.Local).AddTicks(7140))
            ...
            modelBuilder.Entity("Domain.Features.Plans.Entities.Plan", b =>
                {
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp")
                        .HasDefaultValue(new DateTime(2024, 3, 12, 12, 14, 34, 947, DateTimeKind.Local).AddTicks(5150))
                        .HasColumnName("Updated")
                        .HasColumnOrder(6);
            ...
            modelBuilder.Entity("Domain.Features.Subscriptions.Entities.Subscription", b =>
                {
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp")
                        .HasDefaultValue(new DateTime(2024, 3, 12, 12, 14, 34, 946, DateTimeKind.Local).AddTicks(8180))
                        .HasColumnName("Updated");
            ...
            modelBuilder.Entity("Domain.Features.Users.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp")
                        .HasDefaultValue(new DateTime(2024, 3, 12, 12, 14, 34, 951, DateTimeKind.Local).AddTicks(4490))
                        .HasColumnName("Updated")
                        .HasColumnOrder(14);
