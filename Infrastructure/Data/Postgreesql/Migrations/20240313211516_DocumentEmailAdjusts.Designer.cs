...
namespace Infrastructure.Data.Postgreesql.Migrations
{
    ...
    [Migration("20240313211516_DocumentEmailAdjusts")]
    partial class DocumentEmailAdjusts
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Features.Orders.Entities.Order", b =>
                {
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp")
                        .HasDefaultValue(new DateTime(2024, 3, 13, 18, 15, 16, 404, DateTimeKind.Local).AddTicks(3700))
            ...
            modelBuilder.Entity("Domain.Features.Plans.Entities.Plan", b =>
                {
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp")
                        .HasDefaultValue(new DateTime(2024, 3, 13, 18, 15, 16, 408, DateTimeKind.Local).AddTicks(1670))
                        .HasColumnName("Updated")
                        .HasColumnOrder(6);
            ...
            modelBuilder.Entity("Domain.Features.Subscriptions.Entities.Subscription", b =>
                {
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp")
                        .HasDefaultValue(new DateTime(2024, 3, 13, 18, 15, 16, 407, DateTimeKind.Local).AddTicks(3680))
                        .HasColumnName("Updated");
            ...
            modelBuilder.Entity("Domain.Features.Users.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp")
                        .HasDefaultValue(new DateTime(2024, 3, 13, 18, 15, 16, 412, DateTimeKind.Local).AddTicks(520))
                        .HasColumnName("Updated")
                        .HasColumnOrder(14);
